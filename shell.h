 ...
 *@argv:array of strings retrieved from arg
 *@path: path for the current command
 *@argc: argument count
 *@line_count: the error count
 *@err_num: the error code for exit()s
 *@linecount_flag: flag number
 *@fname: filename
 *@env: linked list copy of environ
 *@environ: Extern global var
...
/**
 *struct builtin - contains a builtin string and matching function
 *@type: command flag
 *@func: function
 */
