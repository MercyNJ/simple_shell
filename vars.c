...
/**
 * is_chain - test if current char in buff is a chain delter
 * @info: parameter struct
 * @buf: char buffer
 * @p: address of current pos in buf
 *
...
/**
 * check_chain - Determine if chaining to proceed last status
 * @info: parameter struct
 * @buf: char buffer
 * @p: address of current post in buf
 ...
 * @old: address of string to replace.
 * @new: new string
 *
